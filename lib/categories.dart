...
class YourCategories extends StatefulWidget {
  ...
  _YourCategoriesState createState() => _YourCategoriesState();
}
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            InkWell(
                onTap: () {
                  Navigator.pushNamed(context, "rawwool");
                },
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Image.asset('images/rawwool.webp',
            ...
            InkWell(
                onTap: () {
                  Navigator.pushNamed(context, "prodisc");
                },
                child: Card(
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12.0),
