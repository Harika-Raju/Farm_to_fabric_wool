...
import 'dart:convert';
import 'package:tutorial_coach_mark/tutorial_coach_mark.dart';
import 'in_app_tour_target.dart';
                        ...
                        children: [
                                ...
                                child: Card(
                                  ...
                                  child: Container(
                                    width: MediaQuery.of(context).size.width *
                                        0.26, // Adjust multiplier as needed
                                    ...
                                    child: const ClipOval(
                                        child: Image(
                                      image:
                                          AssetImage("images/woolmarket.jpg"),
                                      fit: BoxFit.cover,
                                    )),
                                  ),
                                ),
                                ...
                                child: Card(
                                  ...
                                  child: Container(
                                    ...
                                    child: const ClipOval(
                                        child: Image(
                                      image:
                                          AssetImage("images/warehouses.jpg"),
                                      fit: BoxFit.cover,
                                    )),
                                  ),
                                ),
                                  ...
                                  child: Card(
                                    ...
                                    child: Container(
                                      ...
                                      child: const ClipOval(
                                          child: Image(
                                        image:
                                            AssetImage("images/tracking.jpg"),
                                        fit: BoxFit.cover,
                                      )),
                                    ),
                                  ),
                          ...
                          Card(
                            ...
                            child: Padding(
                              padding: const EdgeInsets.all(10),
                              child: Container(
                                height: 450, // Adjust multiplier as needed

                                width: MediaQuery.of(context).size.width *
                                    0.2, // Adjust multiplier as needed
